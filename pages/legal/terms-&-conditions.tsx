  ...
  return (
    <VStack w={'full'} minH={'100vh'} pt={8} px={20} gap={10}>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            recommendations based on your skills and interests. By using any of
            our products, software, services, or websites (collectively referred
            to as the &quot;Services&quot;), you agree to comply with these
            Terms of Use.
          </Text>

          <Text as={'p'}>
            Please read these Terms carefully as they govern your access to and
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            Welcome to Scope Seeker! This User Agreement (&quot;Agreement&quot;)
            governs your access to and use of our website and services,
            available at https://www.scopeseeker.com (&quot;Site&quot;).
          </Text>
          ...
          <Text as={'p'}>
            ...
            without prior notice to you. You are responsible for checking this
            Agreement periodically for changes or updates. Your continued use of
            the Site following the posting of any changes to this Agreement
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          ...
          <Box>
            <OrderedList ml={8} spacing={3}>
              <ListItem>
                Your use of our Services is subject to a legal agreement between
                you and Scope Seeker.
              </ListItem>

              <ListItem>
                By using any of our Services, you agree to be bound by our Terms
                of Use.
              </ListItem>
              ...
              <ListItem>
                ...
                continued use of our Services indicates your acceptance of these
                changes.
              </ListItem>

              <ListItem>
                You can accept our Terms of Use by clicking to agree or by using
                our Services.
              </ListItem>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Box>
            <UnorderedList ml={8} spacing={3}>
              <ListItem>
                scopeseekeer.com may modify, suspend, cancel, or discontinue any
                or all channels, products, or services at any time without prior
                notice.
              </ListItem>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            complete the registration process by providing accurate information
            as prompted by the registration form. You will also choose a
            password and username, which will be your email ID. It is your
            responsibility to maintain the confidentiality of your account and
            password. By registering, you agree to the following terms:
          </Text>
          ...
          <Box>
            <OrderedList ml={8} spacing={3}>
              ...
              <ListItem>
                ...
                individuals who have not registered with Unstop.com as users of
                the Site.
              </ListItem>
          ...
          <Text as={'p'}>
            ...
            misused in any manner, we reserve the right to cancel access rights
            immediately without notice and block access to all users from that
            IP address. You are entirely responsible for any activities that
            occur under your account, and you agree to notify us immediately of
            any unauthorized use of your account or any other breach of
            security. We will not be liable for any loss that you may incur as a
            result of someone else using your password or account. However, you
            may be held liable for losses incurred by us or another party due to
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            register for our Services, you will be prompted to create a password
            and account. It is important that you keep this information
            confidential and do not share it with anyone else. You are solely
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            found on our website. We recommend that you read our Privacy Policy
            carefully and contact us if you have any questions or concerns. By
            continuing to use our services, you acknowledge and agree to the
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            Scope Seeker by third parties. It is the responsibility of the party
            providing the material to ensure that it complies with applicable
            laws. Any correspondence or business dealings with advertisers other
            than Scope Seeker found on the website are solely between you and
            the advertiser. We are not responsible for any claims, errors,
            omissions, inaccuracies in advertising material, or any losses or
            damages incurred as a result of such dealings or the presence of
            such advertisers on the website. We reserve the right to omit,
            suspend, or change the position of any advertising material
            submitted for insertion. Acceptance of advertisements on the website
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            to use it. You guarantee that the content does not infringe upon the
            intellectual property rights, property rights, or any other rights
            of third parties. Furthermore, you warrant that you are not aware of
            any action, suit, proceeding, or investigation that has been
            instituted or threatened relating to any content, including
            trademarks, service marks, trade names, or copyrights used by you in
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            website and related services or any part of it at any time, without
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            provided on our website is accurate and of high quality. However, we
            do not warrant or make any representations regarding the quality,
            accuracy, or completeness of any data, information, product, or
            service provided on our site. We will not be liable for any direct,
            indirect, punitive, incidental, special, or consequential damages
            arising out of or in any way connected with the use or inability to
            use our services, unauthorized access to or alteration of user
            transmissions or data, or any other matter related to our services.
          </Text>
          ...
          <Text as={'p'}>
            ...
            related graphics obtained through our website. Additionally, we will
            not be responsible for any non-availability of our website during
            periodic maintenance operations or any unplanned suspension of
            access to our website that may occur due to technical reasons or for
            any reason beyond our control.
          </Text>
          <Text as={'p'}>
            You understand and agree that any material and/or data downloaded or
            otherwise obtained through our website is done at your own
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            personalized job opportunities based on their skills and interests.
            As a user of our website, you agree to indemnify, defend, and hold
            harmless Scope Seeker and its affiliates, officers, directors,
          ...
          <Box>
            <OrderedList ml={8} spacing={3}>
              <ListItem>
                Any breach or alleged breach by you of these Terms of Use or any
                other agreement between you and Scope Seeker;
              </ListItem>
              ...
              <ListItem>
                Any activity related to your account, including but not limited
                to negligent or wrongful conduct by you or any other person
                accessing the website or services using your account.
              </ListItem>
            </OrderedList>
          </Box>

          <Text as={'p'}>
            Scope Seeker reserves the right to assume the exclusive defense and
            control of any matter otherwise subject to indemnification by you,
            in which event you will cooperate with Scope Seeker in asserting any
            available defenses.
          </Text>
        </VStack>
      </VStack>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            effect to its conflict of law provisions. Any dispute arising out of
            or related to these terms and conditions shall be subject to the
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            In the event that any provision of these Terms is deemed invalid or
            unenforceable, only the specific provision or part of the provision
            that is invalid or unenforceable shall be considered as such. The
            remainder of the provision and all other provisions of these Terms
            shall remain valid and enforceable to the fullest extent permitted
            by law.
          </Text>
        </VStack>
      </VStack>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            or material uploaded onto the platform. Unstop.com does not endorse,
            verify or guarantee the accuracy or quality of user-generated
            content on the website. Users may be held legally liable for any
            defamatory, copyrighted or trademarked content they post. If you
            become aware of any violation or abuse of these terms, please report
            it to reportabuse@scopeseekeer.com.
          </Text>
        </VStack>
      </VStack>
          ...
          <Box>
            <OrderedList ml={8} spacing={3}>
              <ListItem>
                ...
                sexually-oriented, hateful, threatening, or otherwise violative
                of any laws.
              </ListItem>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            accounts for the Services you use (if such an option is available).
            scopeseekeer.com may terminate this agreement with you if you breach
            any of the Terms or if it is required to do so by law. Additionally,
            if scopeseekeer.com determines that providing the Services to you is
            no longer commercially viable, it may also terminate the agreement.
          </Text>

          <Text as={'p'}>
            If the agreement is terminated, any legal rights, obligations, or
            liabilities that you and scopeseekeer.com have accrued or benefited from
            during the term of the agreement will not be affected by the
            termination. The provisions of Indemnification and Governing Law
