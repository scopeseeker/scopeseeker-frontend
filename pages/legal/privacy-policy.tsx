          ...
          <Box>
            <UnorderedList ml={8} spacing={3}>
              <ListItem>
                ...
                for listing, organizing, conducting, and administering various
                opportunities like quizzes, hackathons, simulations, or any
                other event type available on the Platform. This includes
                administrative features to interact with Participants.
              </ListItem>

              <ListItem>
                Providing clients with a limited, non-exclusive,
                non-transferable, non-sublicensable license to use the Platform
                for hiring and conducting the recruitment process, such as
                assessments, group discussions, interviews, and other available
                services/products on the Platform. This includes administrative
              ...
              <ListItem>
                ...
                interact, attend, and participate in opportunities conducted by
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          ...
          <Text as={'p'}>
            ...
            questions or concerns about our Privacy Policy, please don&apos;t
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          ...
          <Text as={'p'}>
            ...
            used or shared while hosting the opportunity in case of a client,
            and/or while participating in an opportunity in case of a
          ...
          <Text as={'p'}>
            ...
            wish to participate in an opportunity.
          </Text>
        </VStack>
      </VStack>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          ...
          <Box>
            <OrderedList ml={8} spacing={3}>
              <ListItem>
                ...
                username), title or designation, date of birth, gender, current
                occupation, and the name of your organization (if applicable).
              </ListItem>

              <ListItem>
                Tracking information such as your IP address, device ID, browser
                information, time zone setting, location, internet service
                provider, and details of your platform usage and browsing
                behavior for analytics purposes.
              </ListItem>

              <ListItem>
                Your responses to assessments such as quizzes, hackathons,
                document submissions, simulation games, treasure hunts, case sim
                games, brand stories, and any such gamified assessments for any
                job listing or opportunity.
              </ListItem>
          ...
          <Text as={'p'}>
            ...
            providers. Where you link your LinkedIn profile to your Scope Seeker
            account, we may receive information from your LinkedIn profile as
            well.
          </Text>
          ...
          <Text as={'p'}>
            ...
            unsolicited messages from other parties in return, and Scope Seeker
            site will not be responsible for the use or misuse of such
            information.
          </Text>
          ...
          <Box>
            <UnorderedList ml={8} spacing={3}>
              <ListItem>
                ...
                never sell or rent your information to any third party without
              ...
              <ListItem>
                Finally, if we find that your actions on our website violate our
                terms of service or any of our usage guidelines for specific
                products or services, we reserve the right to take appropriate
                action, which may include sharing your information with law
                enforcement authorities.
              </ListItem>

              <ListItem>
                At Scope Seeker, we value your trust and take your privacy
                seriously. Rest assured that we will only share your information
                when necessary and with your explicit consent.
              </ListItem>
            </UnorderedList>
          </Box>
        </VStack>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          ...
          <Text as={'p'}>
            ...
            recognize your computer and remember what you have done on the
            platform. This ensures that you only need to log in once if you are
            navigating secure areas of the platform and you can see the
          ...
          <Text as={'p'}>
            ...
            full advantage of our platform. We also use various third-party
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            any additional information shared by Participants with clients
            during such events is provided directly by the Participant to the
            client. As such, we are in no way responsible or liable for the use,
            misuse, or treatment of such information. Our Privacy Notice does
            not cover any information shared by the Participant/Candidate with
            the client.
          </Text>
          ...
          <Text as={'p'}>
            ...
            all information collected and accessed through our platform and
            cookies will be maintained in accordance with our Privacy Policy. We
            do use data collection devices such as &quot;cookies&quot; to assist
            us in providing customized services and to help us provide
            information that is targeted to your interests. We also use various
            third-party cookies for usage, behavioural, analytics, and
            preferences data.
          </Text>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            that enables us to track whether they have been followed. We use
            this information to improve the quality of our services and to
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            information we have collected from you is inaccurate, incomplete, or
            out-of-date, please contact us so we can promptly update or correct
            it.
          </Text>
          ...
          <Text as={'p'}>
            ...
            monitor and review our security policies and procedures to ensure
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          <Text as={'p'}>
            ...
            restrictions on the processing of your personal data. Additionally,
            you may request that we provide the personal data you have provided
          ...
          <Text as={'p'}>
            ...
            limited in certain situations, such as when fulfilling your request
            would infringe upon the rights of a third party, or if we are
            required by law to retain certain information. If we rely on any
            relevant exemptions when responding to your request, we will inform
            you accordingly.
          </Text>
          ...
          <Text as={'p'}>
            ...
            information, we may not be able to let you create an account, attend
            events, or provide you with the services you requested. Any other
            information you provide is optional.
          </Text>
        </VStack>
      </VStack>
      ...
      <VStack w={'full'} alignItems={'flex-start'}>
        ...
        <VStack gap={3} alignItems={'flex-start'}>
          ...
          <Text as={'p'}>
            ...
            your request. We will also maintain a record of your request not to
            receive direct marketing or for us to process your data, so we can
